...
namespace APISandbox__Blanca_Segura.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StudentController : ControllerBase
    {
        private readonly LenguajesC27403Context _context;

        public StudentController(LenguajesC27403Context context)
        {
            _context = context;
        }
